...
export const MODEL_TIERS = {
    starter: {
        ...
        llm: { provider: 'google', model: 'gemini-3-flash-preview' },
        llmEdit: { provider: 'google', model: 'gemini-3-flash-preview' },
        safety: { provider: 'google', model: 'gemini-3-flash-preview' },
        maxResolution: '1080p',
        maxDuration: 30,
        maxScenes: 4,
        creditsPerClip: 80,
