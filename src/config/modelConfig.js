...
export const MODEL_TIERS = {
    starter: {
        ...
        llm: { provider: 'google', model: 'gemini-3.1-flash-preview' },
        llmEdit: { provider: 'google', model: 'gemini-3.1-flash-preview' },
        safety: { provider: 'google', model: 'gemini-3.1-flash-preview' },
        maxResolution: '1080p',
        maxDuration: 30,
        maxScenes: 4,
        creditsPerClip: 80,
    ...
    studio: {
        ...
        llm: { provider: 'google', model: 'gemini-3.1-pro-preview' },
        llmEdit: { provider: 'google', model: 'gemini-3.1-pro-preview' },
        safety: { provider: 'google', model: 'gemini-3.1-flash-preview' },
        maxResolution: '4K',
        maxDuration: 120,
        maxScenes: 15,
