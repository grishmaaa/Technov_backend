...
export const MODEL_TIERS = {
    starter: {
        ...
        llmEdit: { provider: 'google', model: 'gemini-2.0-flash' },
        safety: { provider: 'google', model: 'gemini-2.0-flash' },
        maxResolution: '1080p',
        maxDuration: 30,
        maxScenes: 4,
        creditsPerClip: 80,
    ...
    pro: {
        ...
        llm: { provider: 'google', model: 'gemini-2.0-pro-exp' },
        llmEdit: { provider: 'google', model: 'gemini-2.0-flash' },
        safety: { provider: 'google', model: 'gemini-2.0-flash' },
        maxResolution: '4K',
        maxDuration: 60,
    ...
    studio: {
        ...
        llm: { provider: 'google', model: 'gemini-2.0-pro-exp' },
        llmEdit: { provider: 'google', model: 'gemini-2.0-pro-exp' },
        safety: { provider: 'google', model: 'gemini-2.0-flash' },
        maxResolution: '4K',
        maxDuration: 120,
        maxScenes: 15,
