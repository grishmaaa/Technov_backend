...
export const MODEL_TIERS = {
    starter: {
        ...
        llm: { provider: 'google', model: 'gemini-3.1-flash' },
        llmEdit: { provider: 'google', model: 'gemini-3.1-flash' },
        safety: { provider: 'google', model: 'gemini-3.1-flash' },
        maxResolution: '1080p',
        maxDuration: 30,
        maxScenes: 4,
        creditsPerClip: 80,
    ...
    pro: {
        ...
        llm: { provider: 'google', model: 'gemini-3.1-pro' },
        llmEdit: { provider: 'google', model: 'gemini-3.1-flash' },
        safety: { provider: 'google', model: 'gemini-3.1-flash' },
        maxResolution: '4K',
        maxDuration: 60,
    ...
    studio: {
        ...
        llm: { provider: 'google', model: 'gemini-3.1-pro' },
        llmEdit: { provider: 'google', model: 'gemini-3.1-pro' },
        safety: { provider: 'google', model: 'gemini-3.1-flash' },
        maxResolution: '4K',
        maxDuration: 120,
        maxScenes: 15,
