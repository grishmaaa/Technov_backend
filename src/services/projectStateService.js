...
const ALLOWED_TRANSITIONS = {
    ...
    SCENES_GENERATED: ['USER_REVIEW', 'FAILED', 'VIDEO_GENERATION'],
    USER_REVIEW: ['VISUAL_IDENTITY_DECISION', 'FAILED', 'VIDEO_GENERATION'],
    VISUAL_IDENTITY_DECISION: ['ASSETS_READY', 'FAILED', 'VIDEO_GENERATION'],
    ASSETS_READY: ['VIDEO_GENERATION', 'FAILED'],
    VIDEO_GENERATION: ['PREVIEW_READY', 'POST_PROCESSING', 'FAILED'],
    PREVIEW_READY: ['POST_PROCESSING', 'FAILED'],
