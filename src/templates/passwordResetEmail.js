 ...
 */
export const passwordResetEmailTemplate = ({ resetUrl, name }) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                                We received a request to reset your password for your Technov AI account.
                            ...
                            <div style="margin: 20px 0; padding: 16px; background-color: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px;">
                                <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #856404;">
                                    <strong>⚠️ Security Notice:</strong> This reset link expires in 1 hour.
                                </p>
                            </div>
                        </td>
                    </tr>
